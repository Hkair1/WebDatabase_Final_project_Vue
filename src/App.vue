<template>
  ...
  <MyHeader bookName="Tourism Guider" authorName="World Wide" yourName="Harshitha Kairamkonda"/> 
  <BookBox :books=books />
...
export default{
  ...
  methods:{
    //promoises
    async fetchbooks(){
      const res = await fetch('https://gold-comfortable-goldfish.cyclic.app/api');
